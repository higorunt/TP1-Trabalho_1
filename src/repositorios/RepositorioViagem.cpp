...
{
    // Cria a tabela de viagens se nao existir
...
Viagem RepositorioViagem::mapearParaEntidade(sqlite3_stmt *stmt)
{
    ...
    // Supondo que a entidade Conta ja esteja carregada
    Conta conta(contaCodigo, Senha("00000")); // Senha ficticia, pois nao a armazenada aqui
